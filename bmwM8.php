				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="./img/bmw3.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/bmw4.jpg" alt="">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">BMW M3</h2>
							<div>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>Un atleta de élite para la carretera y el circuito que permite disfrutar al máximo de los derrapajes perfectos, las curvas rápidas y las rectas largas. Vivirás experiencias de máxima adrenalina con las manos sobre el volante de excelente agarre y los dedos listos para accionar rápidamente las levas. El conductor, desde el asiento deportivo M, se fusiona con el vehículo. Un deportivo destinado a acelerar el pulso: BMW M3.<br><br>

												

                                            BMW M3:
                                            Consumo de combustible en l/100 km (promedio): 8,8 (8,3)
                                            Emisiones de CO2 en g/km (promedio): 204 (194) <br><br>
                                            Las cifras entre paréntesis corresponden a vehículos con cambio de doble embrague M de siete velocidades con Drivelogic.<br><br>

												

                                            Los datos de consumo se determinan según el ciclo ECE y dependen del tamaño de la llanta y del neumático elegido. Los modelos mostrados incluyen equipamiento opcional. </p>
										</div>
									</div>
								</div>
								<!-- /tab1  -->
									...
									<div class="row">
										<div class="col-md-12">
											...
											<p>Carrocería: Coupé <br>
												...
												Maletero: 315 L <br>
												Potencia: 450 CV <br>
												Consumo: 8,8 L/100km <br>
												Precio: 140.860,56 € <br>
