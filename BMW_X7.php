				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							...
							<div class="product-preview">
								<img src="./img/X7b.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/X7c.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/X7d.jpg" alt="">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-5">
						<div class="product-details">
							<h2 class="product-name">BMW X7</h2>
							<div>
							...
							<div>
								<h3 class="product-price">83.000€ </h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>Una declaración de lujo: el primer BMW X7 ofrece una elegante fusión de presencia y personalidad. A pesar de su aspecto superior, da impresión de ligereza y agilidad gracias a su diseño purista y estilo atlético. </p>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab1" class="tab-pane fade in active">
									<div class="row">
										<div class="col-md-12">
											<p>El BMW X7 M50d irradia potencia pura y dominio. El distintivo exterior, junto con el potente motor, dispara la adrenalina para acelerar los corazones de los fans del mundo de la competición. Elegante y potente: en diseño y funcionalidad.<br><br>
                                            Una personalidad única: los equipamientos opcionales BMW Individual elevan el BMW X7 a un nivel especial de exclusividad. La pintura Ametrin metalizada dota al vehículo de un carácter seductor y un carisma espectacular. En el interior, la combinación de exclusivo cuero y detalles decorativos de contraste genera una atmósfera incomparable. <br><br>

                                            

                                            Las cifras de consumo de combustible, emisiones de CO2 y consumo eléctrico se han calculado según el Reglamento (CE) 715/2007 en la versión aplicable a la fecha de aprobación. Las cifras hacen referencia a un vehículo con equipamiento de serie en Alemania; el intervalo mostrado considera el equipamiento opcional y la diferencia de tamaño de las llantas y los neumáticos seleccionados.
<br><br>
					...
					<div class="row" id="contacto">
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<p>Somos una empresa de nueva creación con el respaldo y la experiència en Servicios para el automóvil de la empresa Benitez Florit S.L. con más de 35 años trabajando en el sector.</p>
					...
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<span class="copyright">
								...
								Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | CARS & COSAS
							<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
							</span>
						</div>
					</div>
