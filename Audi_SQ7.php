				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-preview">
								<img src="./img/SQ7.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/SQ7b.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/SQ7c.jpg" alt="">
							</div>

							<div class="product-preview">
								<img src="./img/SQ7d.jpg" alt="">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">113.130€ </h3>
								<span class="product-available">In Stock</span>
							</div>
							<p>Te vas a hacer una idea de lo bestia que es el Audi SQ7 con el siguiente dato: su motor tiene un par de 91,8 kilográmetros, exactamente el mismo que homologa ¡un Ferrari LaFerrari de 963 caballos! </p>
