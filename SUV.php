					...
					<div class="aside">
						...
						<div class="checkbox-filter">
							...
							<div class="input-checkbox">
								<input type="checkbox" id="category-1" display= "inline"; onchange="checkSUV()">
							...
							<div class="input-checkbox">
								<input type="checkbox" id="category-2" display= "inline"; onchange="checkSUV()">
							...
							<div class="input-checkbox">
								<input type="checkbox" id="category-3" display= "inline"; onchange="checkSUV()">
							...
							<div class="input-checkbox">
								<input type="checkbox" id="category-4" display= "inline"; onchange="checkSUV()">
...
<!-- aside Widget --><!-- aside Widget --><!-- aside Widget -->
				...
				<div id="store" class="col-md-9">
					...
					<div class="row">
						...
						<!-- product -->
						<div class="col-md-4 col-xs-6" id="6x6" style="display:inline;">
							<div class="product">
								<div class="product-img">
